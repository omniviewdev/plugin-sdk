...
type ResourceDiscoveryClientFactory[ClientT any] interface {
	...
	CreateClient(ctx *types.PluginContext, authContext *types.AuthContext) (*ClientT, error)
	...
	RefreshClient(ctx *types.PluginContext, authContext *types.AuthContext, client *ClientT) error
