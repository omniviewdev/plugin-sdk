...
const file_proto_v1_resource_relationship_proto_rawDesc = "" +
	"\n" +
	"$proto/v1/resource/relationship.proto\x12\x18omniview.sdk.resource.v1\x1a\x1egoogle/protobuf/wrappers.proto\"\x9b\x03\n" +
	...
	"\textractor\x18\x06 \x01(\v2/.omniview.sdk.resource.v1.RelationshipExtractorR\textractor\x12\x1c\n" +
	"\tdirection\x18\a \x01(\tR\tdirection\x12G\n" +
	"\x11target_namespaced\x18\b \x01(\v2\x1a.google.protobuf.BoolValueR\x10targetNamespaced\"\xa5\x02\n" +
	"\x15RelationshipExtractor\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x1d\n" +
	"\n" +
	"field_path\x18\x02 \x01(\tR\tfieldPath\x12(\n" +
	"\x0eowner_ref_kind\x18\x03 \x01(\tB\x02\x18\x01R\fownerRefKind\x12i\n" +
	...
	"\rrelationships\x18\x01 \x03(\v2..omniview.sdk.resource.v1.ResolvedRelationshipR\rrelationships*\x8a\x02\n" +
	...
	"\x1bRELATIONSHIP_TYPE_MEMBER_OF\x10\x06\x12\x1d\n" +
	"\x19RELATIONSHIP_TYPE_SELECTS\x10\aB@Z>github.com/omniviewdev/plugin-sdk/proto/v1/resource;resourcepbb\x06proto3"
...
var file_proto_v1_resource_relationship_proto_depIdxs = []int32{
	...
	13, // 2: omniview.sdk.resource.v1.RelationshipDescriptor.target_namespaced:type_name -> google.protobuf.BoolValue
	12, // 3: omniview.sdk.resource.v1.RelationshipExtractor.label_selector:type_name -> omniview.sdk.resource.v1.RelationshipExtractor.LabelSelectorEntry
	1,  // 4: omniview.sdk.resource.v1.ResolvedRelationship.descriptor:type_name -> omniview.sdk.resource.v1.RelationshipDescriptor
	3,  // 5: omniview.sdk.resource.v1.ResolvedRelationship.targets:type_name -> omniview.sdk.resource.v1.ResourceRef
	3,  // 6: omniview.sdk.resource.v1.RelationshipEdge.source:type_name -> omniview.sdk.resource.v1.ResourceRef
	3,  // 7: omniview.sdk.resource.v1.RelationshipEdge.target:type_name -> omniview.sdk.resource.v1.ResourceRef
	1,  // 8: omniview.sdk.resource.v1.RelationshipEdge.descriptor:type_name -> omniview.sdk.resource.v1.RelationshipDescriptor
	3,  // 9: omniview.sdk.resource.v1.DependencyTree.root:type_name -> omniview.sdk.resource.v1.ResourceRef
	7,  // 10: omniview.sdk.resource.v1.DependencyTree.children:type_name -> omniview.sdk.resource.v1.DependencyNode
	5,  // 11: omniview.sdk.resource.v1.DependencyNode.edge:type_name -> omniview.sdk.resource.v1.RelationshipEdge
	7,  // 12: omniview.sdk.resource.v1.DependencyNode.children:type_name -> omniview.sdk.resource.v1.DependencyNode
	1,  // 13: omniview.sdk.resource.v1.RelationshipsResponse.relationships:type_name -> omniview.sdk.resource.v1.RelationshipDescriptor
	4,  // 14: omniview.sdk.resource.v1.ResolveRelationshipsResponse.relationships:type_name -> omniview.sdk.resource.v1.ResolvedRelationship
