...
// 	protoc        (unknown)
// source: proto/v1/settings/settings.proto
...
func (SettingType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_v1_settings_settings_proto_enumTypes[0].Descriptor()
}

func (SettingType) Type() protoreflect.EnumType {
	return &file_proto_v1_settings_settings_proto_enumTypes[0]
}
...
func (SettingType) EnumDescriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{0}
}
...
func (VisualResourceComponent_ComponentType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_v1_settings_settings_proto_enumTypes[1].Descriptor()
}

func (VisualResourceComponent_ComponentType) Type() protoreflect.EnumType {
	return &file_proto_v1_settings_settings_proto_enumTypes[1]
}
...
func (VisualResourceComponent_ComponentType) EnumDescriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *SettingsCategory) Reset() {
	*x = SettingsCategory{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[0]
...
func (x *Setting) Reset() {
	*x = Setting{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Setting) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{1}
}
...
func (x *Setting) GetType() SettingType {
	...
	return SettingType_SETTING_TYPE_TEXT
}
...
func (x *SettingOption) Reset() {
	*x = SettingOption{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SettingOption) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{2}
}
...
func (x *SettingFileSelection) Reset() {
	*x = SettingFileSelection{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SettingFileSelection) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetSettingRequest) Reset() {
	*x = GetSettingRequest{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSettingRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{4}
}
...
func (x *GetSettingValueRequest) Reset() {
	*x = GetSettingValueRequest{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSettingValueRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetSettingValueResponse) Reset() {
	*x = GetSettingValueResponse{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSettingValueResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{6}
}
...
func (x *SetSettingRequest) Reset() {
	*x = SetSettingRequest{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetSettingRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{7}
}
...
func (x *SetSettingsRequest) Reset() {
	*x = SetSettingsRequest{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetSettingsRequest) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{8}
}
...
func (x *ListSettingsResponse) Reset() {
	*x = ListSettingsResponse{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSettingsResponse) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{9}
}
...
func (x *VisualComponentList) Reset() {
	*x = VisualComponentList{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VisualComponentList) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{10}
}
...
type VisualResourceComponent struct {
	...
	Type VisualResourceComponent_ComponentType `protobuf:"varint,3,opt,name=type,proto3,enum=omniview.sdk.settings.v1.VisualResourceComponent_ComponentType" json:"type,omitempty"`
...
func (x *VisualResourceComponent) Reset() {
	*x = VisualResourceComponent{}
	mi := &file_proto_v1_settings_settings_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VisualResourceComponent) Descriptor() ([]byte, []int) {
	return file_proto_v1_settings_settings_proto_rawDescGZIP(), []int{11}
}
...
const file_proto_v1_settings_settings_proto_rawDesc = "" +
	"\n" +
	" proto/v1/settings/settings.proto\x12\x18omniview.sdk.settings.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x19google/protobuf/any.proto\"\xa4\x02\n" +
	"\x10SettingsCategory\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x12\n" +
	"\x04icon\x18\x04 \x01(\tR\x04icon\x12T\n" +
	...
	"\x04type\x18\x04 \x01(\x0e2%.omniview.sdk.settings.v1.SettingTypeR\x04type\x12*\n" +
	...
	"\x12SetSettingsRequest\x12V\n" +
	"\bsettings\x18\x01 \x03(\v2:.omniview.sdk.settings.v1.SetSettingsRequest.SettingsEntryR\bsettings\x1aQ\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01\"\xd0\x01\n" +
	"\x14ListSettingsResponse\x12X\n" +
	"\bsettings\x18\x01 \x03(\v2<.omniview.sdk.settings.v1.ListSettingsResponse.SettingsEntryR\bsettings\x1a^\n" +
	"\rSettingsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x127\n" +
	"\x05value\x18\x02 \x01(\v2!.omniview.sdk.settings.v1.SettingR\x05value:\x028\x01\"d\n" +
	"\x13VisualComponentList\x12M\n" +
	"\bresource\x18\x01 \x03(\v21.omniview.sdk.settings.v1.VisualResourceComponentR\bresource\"\xfc\x01\n" +
	"\x17VisualResourceComponent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06plugin\x18\x02 \x01(\tR\x06plugin\x12S\n" +
	"\x04type\x18\x03 \x01(\x0e2?.omniview.sdk.settings.v1.VisualResourceComponent.ComponentTypeR\x04type\x12\x1c\n" +
	...
	"\n" +
	"GetSetting\x12+.omniview.sdk.settings.v1.GetSettingRequest\x1a!.omniview.sdk.settings.v1.Setting\x12v\n" +
	"\x0fGetSettingValue\x120.omniview.sdk.settings.v1.GetSettingValueRequest\x1a1.omniview.sdk.settings.v1.GetSettingValueResponse\x12Q\n" +
	"\n" +
	"SetSetting\x12+.omniview.sdk.settings.v1.SetSettingRequest\x1a\x16.google.protobuf.Empty\x12S\n" +
	"\vSetSettings\x12,.omniview.sdk.settings.v1.SetSettingsRequest\x1a\x16.google.protobuf.EmptyB@Z>github.com/omniviewdev/plugin-sdk/proto/v1/settings;settingspbb\x06proto3"

var (
	file_proto_v1_settings_settings_proto_rawDescOnce sync.Once
	file_proto_v1_settings_settings_proto_rawDescData []byte
)

func file_proto_v1_settings_settings_proto_rawDescGZIP() []byte {
	file_proto_v1_settings_settings_proto_rawDescOnce.Do(func() {
		file_proto_v1_settings_settings_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_v1_settings_settings_proto_rawDesc), len(file_proto_v1_settings_settings_proto_rawDesc)))
	})
	return file_proto_v1_settings_settings_proto_rawDescData
}

var file_proto_v1_settings_settings_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_proto_v1_settings_settings_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_proto_v1_settings_settings_proto_goTypes = []any{
	(SettingType)(0), // 0: omniview.sdk.settings.v1.SettingType
	(VisualResourceComponent_ComponentType)(0), // 1: omniview.sdk.settings.v1.VisualResourceComponent.ComponentType
	(*SettingsCategory)(nil),                   // 2: omniview.sdk.settings.v1.SettingsCategory
	(*Setting)(nil),                            // 3: omniview.sdk.settings.v1.Setting
	(*SettingOption)(nil),                      // 4: omniview.sdk.settings.v1.SettingOption
	(*SettingFileSelection)(nil),               // 5: omniview.sdk.settings.v1.SettingFileSelection
	(*GetSettingRequest)(nil),                  // 6: omniview.sdk.settings.v1.GetSettingRequest
	(*GetSettingValueRequest)(nil),             // 7: omniview.sdk.settings.v1.GetSettingValueRequest
	(*GetSettingValueResponse)(nil),            // 8: omniview.sdk.settings.v1.GetSettingValueResponse
	(*SetSettingRequest)(nil),                  // 9: omniview.sdk.settings.v1.SetSettingRequest
	(*SetSettingsRequest)(nil),                 // 10: omniview.sdk.settings.v1.SetSettingsRequest
	(*ListSettingsResponse)(nil),               // 11: omniview.sdk.settings.v1.ListSettingsResponse
	(*VisualComponentList)(nil),                // 12: omniview.sdk.settings.v1.VisualComponentList
	(*VisualResourceComponent)(nil),            // 13: omniview.sdk.settings.v1.VisualResourceComponent
	nil,                                        // 14: omniview.sdk.settings.v1.SettingsCategory.SettingsEntry
	nil,                                        // 15: omniview.sdk.settings.v1.SetSettingsRequest.SettingsEntry
	nil,                                        // 16: omniview.sdk.settings.v1.ListSettingsResponse.SettingsEntry
	(*anypb.Any)(nil),                          // 17: google.protobuf.Any
	(*emptypb.Empty)(nil),                      // 18: google.protobuf.Empty
}
var file_proto_v1_settings_settings_proto_depIdxs = []int32{
	14, // 0: omniview.sdk.settings.v1.SettingsCategory.settings:type_name -> omniview.sdk.settings.v1.SettingsCategory.SettingsEntry
	0,  // 1: omniview.sdk.settings.v1.Setting.type:type_name -> omniview.sdk.settings.v1.SettingType
	17, // 2: omniview.sdk.settings.v1.Setting.value:type_name -> google.protobuf.Any
	17, // 3: omniview.sdk.settings.v1.Setting.default:type_name -> google.protobuf.Any
	4,  // 4: omniview.sdk.settings.v1.Setting.options:type_name -> omniview.sdk.settings.v1.SettingOption
	5,  // 5: omniview.sdk.settings.v1.Setting.file_selection:type_name -> omniview.sdk.settings.v1.SettingFileSelection
	17, // 6: omniview.sdk.settings.v1.SettingOption.value:type_name -> google.protobuf.Any
	17, // 7: omniview.sdk.settings.v1.GetSettingValueResponse.value:type_name -> google.protobuf.Any
	17, // 8: omniview.sdk.settings.v1.SetSettingRequest.value:type_name -> google.protobuf.Any
	15, // 9: omniview.sdk.settings.v1.SetSettingsRequest.settings:type_name -> omniview.sdk.settings.v1.SetSettingsRequest.SettingsEntry
	16, // 10: omniview.sdk.settings.v1.ListSettingsResponse.settings:type_name -> omniview.sdk.settings.v1.ListSettingsResponse.SettingsEntry
	13, // 11: omniview.sdk.settings.v1.VisualComponentList.resource:type_name -> omniview.sdk.settings.v1.VisualResourceComponent
	1,  // 12: omniview.sdk.settings.v1.VisualResourceComponent.type:type_name -> omniview.sdk.settings.v1.VisualResourceComponent.ComponentType
	3,  // 13: omniview.sdk.settings.v1.SettingsCategory.SettingsEntry.value:type_name -> omniview.sdk.settings.v1.Setting
	17, // 14: omniview.sdk.settings.v1.SetSettingsRequest.SettingsEntry.value:type_name -> google.protobuf.Any
	3,  // 15: omniview.sdk.settings.v1.ListSettingsResponse.SettingsEntry.value:type_name -> omniview.sdk.settings.v1.Setting
	18, // 16: omniview.sdk.settings.v1.SettingsPlugin.ListSettings:input_type -> google.protobuf.Empty
	6,  // 17: omniview.sdk.settings.v1.SettingsPlugin.GetSetting:input_type -> omniview.sdk.settings.v1.GetSettingRequest
	7,  // 18: omniview.sdk.settings.v1.SettingsPlugin.GetSettingValue:input_type -> omniview.sdk.settings.v1.GetSettingValueRequest
	9,  // 19: omniview.sdk.settings.v1.SettingsPlugin.SetSetting:input_type -> omniview.sdk.settings.v1.SetSettingRequest
	10, // 20: omniview.sdk.settings.v1.SettingsPlugin.SetSettings:input_type -> omniview.sdk.settings.v1.SetSettingsRequest
	11, // 21: omniview.sdk.settings.v1.SettingsPlugin.ListSettings:output_type -> omniview.sdk.settings.v1.ListSettingsResponse
	3,  // 22: omniview.sdk.settings.v1.SettingsPlugin.GetSetting:output_type -> omniview.sdk.settings.v1.Setting
	8,  // 23: omniview.sdk.settings.v1.SettingsPlugin.GetSettingValue:output_type -> omniview.sdk.settings.v1.GetSettingValueResponse
	18, // 24: omniview.sdk.settings.v1.SettingsPlugin.SetSetting:output_type -> google.protobuf.Empty
	18, // 25: omniview.sdk.settings.v1.SettingsPlugin.SetSettings:output_type -> google.protobuf.Empty
...
func init() { file_proto_v1_settings_settings_proto_init() }
func file_proto_v1_settings_settings_proto_init() {
	if File_proto_v1_settings_settings_proto != nil {
		return
	}
	file_proto_v1_settings_settings_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_v1_settings_settings_proto_rawDesc), len(file_proto_v1_settings_settings_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   15,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_v1_settings_settings_proto_goTypes,
		DependencyIndexes: file_proto_v1_settings_settings_proto_depIdxs,
		EnumInfos:         file_proto_v1_settings_settings_proto_enumTypes,
		MessageInfos:      file_proto_v1_settings_settings_proto_msgTypes,
	}.Build()
	File_proto_v1_settings_settings_proto = out.File
	file_proto_v1_settings_settings_proto_goTypes = nil
	file_proto_v1_settings_settings_proto_depIdxs = nil
}
