...
func file_proto_resource_informer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_resource_informer_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_resource_informer_proto_msgTypes[3].OneofWrappers = []interface{}{
